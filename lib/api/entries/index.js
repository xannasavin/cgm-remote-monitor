  ...
  function prep_patterns (req, res, next) {
    ...
    function iter_regex (prefix, suffix) {
      ...
      function make (pat) {
        ...
        // eslint-disable-next-line security/detect-non-literal-regexp -- legacy API regex feature; input is API-authorised caller, prefix/suffix constrained upstream
