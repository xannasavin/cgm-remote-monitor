...
// These instruct the LLM to return treatment_insights and use dd.mm.yyyy dates.
var DEFAULT_SYSTEM_PROMPT = 'You are a diabetes data analyst. Analyze CGM (Continuous Glucose Monitor) data and provide actionable insights. '
  + 'Format all dates as {{DATEFORMAT}} in your response text. '
  + 'Always include treatment_insights in your response with carb_patterns, insulin_patterns, basal_observations, and dosing_observations. '
  + 'Analyze the basal profile for patterns like dawn phenomenon, overnight adequacy, and profile gaps. '
  + 'Respond in {{LANGUAGE}}. Return your analysis as JSON matching the schema in {{RETURNFORMAT}}.';

var DEFAULT_USER_PROMPT = 'Analyze the following CGM data for {{DAYS}} days ({{TIMEFROM}} to {{TIMETILL}}).\n\n'
  + 'CGM Data:\n{{CGMDATA_JSON}}\n\n'
  + 'Pre-computed Statistics:\n{{STATS_JSON}}\n\n'
  + 'Patient Profile (basal rates, carb ratios, sensitivity factors):\n{{PROFILE_JSON}}\n\n'
  + 'Treatment Summary (carbs/insulin totals):\n{{TREATMENT_SUMMARY}}\n\n'
