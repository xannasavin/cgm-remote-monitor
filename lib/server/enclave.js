...
const init = function init () {
  ...
  function readKey (filename) {
    ...
    // eslint-disable-next-line security/detect-non-literal-fs-filename -- filename is a hardcoded internal cache key (see call site below)
    if (fs.existsSync(filePath)) {
      // eslint-disable-next-line security/detect-non-literal-fs-filename -- same as existsSync check above
