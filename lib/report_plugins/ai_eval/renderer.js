...
function renderStats (periodStats, dayStats, meta, dayDates) {
  ...
  return '<div class="cgm-wrap">'
    ...
    + (diurnalHtml ? '<section><h2>Diurnal Patterns</h2><div id="aiDiurnalChart"></div>' + diurnalHtml + '</section>' : '')
    + '<section><h2>Daily Breakdown</h2><div id="aiDailyTirChart"></div>' + dayTable + '</section>'
    + '</div>';
}
