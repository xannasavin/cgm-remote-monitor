    ...
    $.ajax({
      ...
      , success: function (prompts) {
        ...
        if (reportData && reportData.datastorage) {
          ...
          if (statsArea) {
            var statsHtml = renderer.renderStats(result.periodStats, result.dayStats, result.cgmData.meta, dayDates);
            ...
            requestAnimationFrame(function () {
              ...
              if (result.dayStats && result.dayStats.length > 1) {
                charts.renderDailyTirChart('#aiDailyTirChart', result.dayStats, dayDates, result.cgmData.meta);
              }
            });
          }
