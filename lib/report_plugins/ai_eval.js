...
function init(ctx) {
    ...
    function initializeAiEvalTab(passedInClient) {
        ...
        console.log('AI Eval DEBUG Settings ai eval top', ctx.settings.ai_fuck_you_test)
        ...
        if (typeof window.jQuery === 'function') {
            ...
            console.log('AI Eval DEBUG Settings passed in client:', passedInClient.settings);
