            ...
            sendButton.addEventListener('click', function () {
                ...
                fetch(apiEndpoint, {
                    ...
                    .then(data => {
                        ...
                        if (passedInClient.settings.ai_llm_debug === true && interimResponseDebugArea) {
                            interimResponseDebugArea.textContent = 'Raw Interim AI Response (from /api/v1/ai_eval):\n\n' + JSON.stringify(data, null, 2);
                        }
                    })
                    .catch(error => {
                        ...
                        button.textContent = 'Send to AI'; // Reset button
                        button.disabled = false;
                        if (interimResponseDebugArea) { // Display error in response debug area regardless of debug mode for visibility
                            interimResponseDebugArea.style.display = 'block'; // Ensure it's visible
