            ...
            sendButton.addEventListener('click', async function () {
                ...
                $.ajax({
                    ...
                    success: function (prompts) {
                        ...
                        finalUserPrompt = finalUserPrompt.replace('{{DAYS}}', String(reformatedInterimResponses.interim_calls_amount));
                        if (typeof window !== 'undefined') {
                            ...
                            console.error('No Profile data for final prompt available');
                        }
