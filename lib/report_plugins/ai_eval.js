                ...
                success: function (prompts) {
                    ...
                    if (reportData && reportData.datastorage) {
                        ...
                        if (reportData.datastorage) {
                            ...
                            let userInterimPromptContent = userPromptContent; // JUST A TEMP PLACEHOLDER! NEEDS TO BE REMOVED AS SOON AS THE REAL INTERIM PROMPT IS IN PLACE
                            let systemInterimPromptContent = systemPromptContent; // JUST A TEMP PLACEHOLDER! NEEDS TO BE REMOVED AS SOON AS THE REAL INTERIM PROMPT IS IN PLACE
