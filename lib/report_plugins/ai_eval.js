...
function init(ctx) {
  ...
  function initializeAiEvalTab(passedInClient) {
    ...
    console.log('AI Eval: API URL from settings:', apiUrlFromSettings); // Original log
    console.log('AI Eval: Model from settings:', modelFromSettings); // Original log
    console.log('AI Eval: API Key is set from settings:', apiKeyIsSetFromSettings); // Original log

    // Temporary DEBUG logs as per plan step 2
    console.log('AI Eval DEBUG: API URL from settings:', apiUrlFromSettings);
    console.log('AI Eval DEBUG: ai_llm_key_set from settings:', apiKeyIsSetFromSettings);
