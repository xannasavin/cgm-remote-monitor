            ...
            $.ajax({
                ...
                success: function (prompts) {
                    ...
                    if (reportData && reportData.datastorage) {
                        ...
                        let userPromptContent = prompts.user_prompt_template || "Analyze the following CGM data: {{CGMDATA}} using this profile: {{PROFILE}}"; // Added {{PROFILE}} to default
                        ...
                        } else if (reportData.datastorage.profile) {
                        ...
                        if (activeProfile) {
                            profileString = JSON.stringify(activeProfile, null, 2);
                        } else {
                            console.warn('AI Eval: Could not extract a specific active profile for {{PROFILE}} token.');
                        }
