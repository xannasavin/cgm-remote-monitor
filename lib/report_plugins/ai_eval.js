      ...
      sendButton.addEventListener('click', async function () {
        ...
        try {
          ...
          var statsHtml = '<p><strong>AI Usage</strong><br>'
            ...
            + '<ul>'
            + '<li>Prompt Tokens: ' + usage.prompt_tokens + ' ' + costTracker.formatCost(usage.prompt_tokens, costInput) + '</li>'
            + '<li>Completion Tokens: ' + usage.completion_tokens + ' ' + costTracker.formatCost(usage.completion_tokens, costOutput) + '</li>'
          ...
          if (analysisArea) {
            ...
            retryBtn.addEventListener('click', function () {
              document.getElementById('sendToAiButton').click();
            });
