...
function init () {
  ...
  var settings = {
    ...
    , ai_llm_temperature: 0.7 // Default temperature for LLM
    , ai_llm_max_tokens: 200 // Default max tokens for LLM response
  ...
  console.log('AI Eval DEBUG  Settings 0:', settings)
  ...
  console.log('AI Eval DEBUG  Settings 1:', settings)
  ...
  console.log('AI Eval DEBUG  Key:',settings.ai_llm_key);
  console.log('AI Eval DEBUG  Key set:',settings.ai_llm_key_is_set);
  console.log('AI Eval DEBUG  Fuck you set:',settings.ai_fuck_you_test);
