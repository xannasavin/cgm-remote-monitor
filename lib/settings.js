...
function init () {
  ...
  console.log('AI Key:',settings.ai_llm_key);
  console.log('AI Key set:',settings.ai_llm_key_is_set);
  console.log('Settings 8:', settings)
